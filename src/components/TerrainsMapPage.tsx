...
const terrainSpots: TerrainSpot[] = [
  {
    id: 'adetikopé',
...
export const TerrainsMapPage: React.FC = () => {
  const [selectedId, setSelectedId] = useState<string>(terrainSpots[0].id);
    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.35fr_0.95fr] gap-6">
        <div className="glass-panel rounded-3xl border border-white/10 p-4 sm:p-5">
          ...
          <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-gradient-to-br from-emerald-950/40 via-slate-950 to-slate-900 min-h-[460px]">
