...
import { Wallet, TrendingUp, TrendingDown, FileText, Plus, CheckCircle, Clock, Download, Filter } from 'lucide-react';
...
export const FinanceManager: React.FC = () => {
  ...
  const handleAddTransaction = (e: React.FormEvent) => {
    ...
    const item: FinancialTransaction = {
      ...
      type: newType,
      userOrOrg: newOrg || 'Club FIRE STONE',
      status: 'PAYÉ',
    };
    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold text-xs shadow-lg hover:scale-105 transition-all"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div className="glass-panel p-6 rounded-3xl border border-white/10 space-y-2">
          ...
          <div className="text-xs text-emerald-400 font-medium">Compte bancaire FIRE STONE</div>
        </div>
          ...
          <div className="glass-panel rounded-3xl border border-white/20 max-w-md w-full p-6 space-y-5">
            ...
            <form onSubmit={handleAddTransaction} className="space-y-4 text-xs">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 py-2.5 rounded-xl bg-[#FF2A3B] text-white font-bold hover:bg-red-600 shadow-md"
                >
                  Enregistrer
                </button>
              </div>
