...
export const MessagingSystem: React.FC<MessagingSystemProps> = ({ currentRole }) => {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-[650px] glass-panel rounded-3xl border border-white/10 overflow-hidden">
            ...
            <button
              ...
              className={`w-full p-3 rounded-2xl flex items-center justify-between transition-all ${
                activeChannel === 'GENERAL'
                  ? 'bg-gradient-to-r from-[#FF2A3B] to-[#E60023] text-white font-bold shadow-md'
