...
export const ChampionsDayManager: React.FC<ChampionsDayManagerProps> = ({ currentRole }) => {
  ...
  const pastEditionVideos = [
    ...
    { id: 'v3', year: 2025, title: 'Cérémonie Officielle des Trophées & Discours du Coach Vance', url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', thumbnail: 'https://images.unsplash.com/photo-1519766304817-4f37bda74a29?w=600&auto=format&fit=crop&q=80', views: 3100, duration: '32min' },
  ...
  const pastEditionPhotos = [
    ...
    { url: 'https://images.unsplash.com/photo-1519766304817-4f37bda74a29?w=600&auto=format&fit=crop&q=80', caption: 'Cérémonie des Médailles 2025' },
  ...
  const tierStyle: Record<EventSponsor['tier'], string> = {
    'PLATINE': 'bg-gradient-to-r from-slate-200 to-white text-slate-900 font-black border-slate-300',
    'OR': 'bg-gradient-to-r from-[#D97706] to-amber-600 text-black font-black border-amber-400',
    'ARGENT': 'bg-gradient-to-r from-slate-400 to-slate-500 text-white font-bold border-slate-400',
    'PARTENAIRE': 'bg-gradient-to-r from-blue-700 to-blue-600 text-white font-bold border-blue-500',
  };
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="relative glass-panel rounded-3xl overflow-hidden border border-amber-500/30 shadow-2xl shadow-red-950/60 bg-[#0A0C13]">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-red-950/60 via-[#0A0C13] to-amber-950/50" />
        ...
        <div className="relative z-10 p-6 sm:p-10 lg:p-12 space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <span className="px-4 py-1.5 rounded-full bg-gradient-to-r from-[#D97706] to-amber-700 text-black text-xs font-black uppercase tracking-wider shadow-lg flex items-center gap-1.5">
          ...
          {isAdminOrCoach && (
            <div className="pt-2 flex flex-wrap gap-3">
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#D97706] to-amber-700 text-black font-extrabold text-xs shadow-lg hover:scale-105 transition-all flex items-center gap-2"
              >
        ...
        {[
          ...
          <button
            ...
            className={`px-4 py-2.5 rounded-2xl text-xs font-extrabold transition-all shrink-0 flex items-center gap-2 ${
              activeTab === tab.id
                ? 'bg-gradient-to-r from-[#B91C1C] to-[#881337] text-white shadow-lg shadow-red-950/50'
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                ...
                <div
                  key={idx}
                  className={`glass-panel p-6 rounded-3xl border ${trophy.borderColor} bg-gradient-to-b ${trophy.bg} to-[#0A0C13] space-y-3 group hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 cursor-default`}
                >
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {participatingTeams.map((team) => (
              <div
                key={team.id}
                className={`glass-panel p-5 rounded-3xl border border-white/10 space-y-4 bg-gradient-to-b ${team.color} to-[#0A0C13] hover:border-white/25 hover:-translate-y-1 transition-all duration-300 group`}
              >
                <div className="flex items-center gap-3">
        ...
        <div className="space-y-6">
          ...
          {(['PRE_JOURNEE', 'JOUR_J'] as const).map((day) => (
            <div key={day} className="space-y-3">
              <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-extrabold uppercase tracking-wider ${day === 'PRE_JOURNEE' ? 'bg-purple-500/20 text-purple-200 border border-purple-500/30' : 'bg-gradient-to-r from-[#D97706] to-amber-700 text-black'}`}>
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {medicalStands.map((stand) => (
              <div key={stand.id} className="glass-panel p-6 rounded-3xl border border-emerald-500/30 bg-gradient-to-br from-emerald-950/25 via-[#0A0C13] to-black space-y-3 hover:-translate-y-1 transition-all">
          ...
          <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-white/15 max-w-2xl w-full space-y-5 bg-[#0D0E15] max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSaveAdmin} className="space-y-4 text-xs">
              ...
              <div className="flex justify-end gap-3 pt-3 border-t border-white/10">
                ...
                <button type="submit" className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-[#D97706] to-amber-700 text-black font-extrabold shadow-lg flex items-center gap-2 hover:scale-105 transition-all">
