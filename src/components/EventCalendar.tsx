          ...
          >
            ...
            {event.coverImage && (
              <div className="relative h-40 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A0C13] via-[#0A0C13]/40 to-transparent" />
                      ...
                      <>
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            className="flex-2 px-6 py-2 rounded-xl bg-gradient-to-r from-[#B91C1C] to-[#881337] text-white text-xs font-bold disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 hover:opacity-90 transition-opacity"
                          >
