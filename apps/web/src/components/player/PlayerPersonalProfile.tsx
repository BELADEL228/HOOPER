...
export const PlayerPersonalProfile: React.FC<PlayerPersonalProfileProps> = ({
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      {/* ============================================================== */}
      <div className="glass-panel p-6 rounded-3xl border border-amber-500/30 space-y-4 bg-linear-to-r from-amber-950/20 via-[#0A0C13] to-red-950/20 relative overflow-hidden">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-white/10">
          ...
          {isCoachOrAdmin && (
            <button
              ...
              className="px-4 py-2 rounded-xl bg-linear-to-r from-[#D97706] to-amber-700 text-black font-extrabold text-xs shadow-md hover:scale-105 transition-all self-start sm:self-auto flex items-center gap-1.5"
            >
          ...
          <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-white/15 max-w-xl w-full space-y-5 bg-[#0D0E15]">
            ...
            <form onSubmit={handlePostCoachFeedback} className="space-y-4 text-xs">
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="px-6 py-2.5 rounded-xl bg-linear-to-r from-[#D97706] to-amber-700 text-black font-extrabold shadow-lg flex items-center gap-2"
                >
